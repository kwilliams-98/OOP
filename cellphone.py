...
class CellPhone:
    ...
    def __init__(self, manufact, model, price):
        self.__manufact = manufact #three attribute; accessor and mutator methods for each attribute 
        self.__model = model
        self.__retail_price = price

    # The set_manufact method accepts an argument for
    # the phone's manufacturer. (note that each method should only do one thing!)
